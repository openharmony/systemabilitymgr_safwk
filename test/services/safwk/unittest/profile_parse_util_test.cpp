...
class ProfileParseUtilTest : public testing::Test {
public:
...
void ProfileParseUtilTest::SetUpTestCase()
{
    DTEST_LOG << "SetUpTestCase" << std::endl;
}

void ProfileParseUtilTest::TearDownTestCase()
{
    DTEST_LOG << "TearDownTestCase" << std::endl;
}

void ProfileParseUtilTest::SetUp()
{
...
void ProfileParseUtilTest::TearDown()
{
 ...
 */
HWTEST_F(ProfileParseUtilTest, ParseSaProfile001, TestSize.Level1)
{
 ...
 */
HWTEST_F(ProfileParseUtilTest, ParseSaProfile002, TestSize.Level1)
{
 ...
 * @tc.require: AR000GGVQF
 */
HWTEST_F(ProfileParseUtilTest, ParseSaProfile003, TestSize.Level1)
{
 ...
 * @tc.require: SR000GGVP1
 */
HWTEST_F(ProfileParseUtilTest, GetSaProfiles001, TestSize.Level1)
{
 ...
 * @tc.require: SR000GGVP1
 */
HWTEST_F(ProfileParseUtilTest, GetSaProfiles002, TestSize.Level1)
{
 ...
 */
HWTEST_F(ProfileParseUtilTest, ParseTrustConfig001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, ParseTrustConfig002, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, ParseTrustConfig003, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, ParseTrustConfig004, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, ParseTrustConfig005, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, ParseTrustConfig006, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, RemoveSaProfile001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, RemoveSaProfile002, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, RemoveSaProfile003, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, RemoveSaProfile004, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, RemoveSaProfile005, TestSize.Level1)
{
    DTEST_LOG << " RemoveSaProfile004 start " << std::endl;
    /**
     * @tc.steps: step1. parse multi-sa profile
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, CheckPathExist001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GICSU
 */
HWTEST_F(ProfileParseUtilTest, CheckPathExist002, TestSize.Level1)
{
 ...
 */
HWTEST_F(ProfileParseUtilTest, GetProfile001, TestSize.Level1)
{
 ...
 * @tc.require: AR000GH56I
 */
HWTEST_F(ProfileParseUtilTest, GetProfile002, TestSize.Level1)
{
